...
from geometric_bayesian.utils.types import Matrix, Scalar, Tuple, Optional, Key, Vector, Int
...
class SymOperator(LinearOperator):
    ...
    def diagonalize(
        ...
        if method == 'symeig':
            ...
            alpha, beta, v = lanczos(self, self.shape[0], num_modes, rng_key)
            ...
            d, v, _ = lobpcg_standard(mv_batch, jax.random.uniform(rng_key, shape=(self.shape[0], num_modes)), m=num_iterations)
        else:
