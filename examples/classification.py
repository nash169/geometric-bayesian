...
# %%
from bayax.utils import DataLoader
...
# %%
from bayax.utils.plot import contour_plot, surf_plot
...
# %%
from bayax.integrate import integrate, ef, ode23, ode45
dt, T = 0.01, 5.0
...
# %%
from bayax.geom.embedding import pullmetric, christoffel_sk
...
# %%
from bayax.geom.metric import christoffel_sk
...
# from bayax.integrate.euler_forward import euler_forward
#
# step = integrate(
#     f = dynamics_ggn,
#     dt = dt,
